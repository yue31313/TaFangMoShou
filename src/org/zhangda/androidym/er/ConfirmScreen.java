...
public class ConfirmScreen extends MenuScreen
{
	...
	public ConfirmScreen(MainGame game, ScreenType prevScreen, ConfirmType confirmType)
	{
	...
	private void YesSelected()
	{
		...
		if (this.confirmType == ConfirmType.ExitToMainMenu)
		{
			...
			super.getScreenManager().AddScreen(new MainMenuScreen(this.game, ScreenType.ConfirmScreen));
		}
		else if (this.confirmType == ConfirmType.RestartGame)
		{
			super.getScreenManager().AddScreen(new GameplayScreen(this.game, this.game.getGameplayScreen().getDifficulty(), this.game.getGameplayScreen().getLevel()));
		}
	}
}